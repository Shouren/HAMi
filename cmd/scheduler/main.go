...
func init() {
	...
	rootCmd.Flags().BoolVar(&config.ForceOverwriteDefaultScheduler, "forceOverwriteDefaultScheduler", true, "Overwrite schedulerName in Pod Spec when set to the const DefaultSchedulerName in https://k8s.io/api/core/v1 package")
